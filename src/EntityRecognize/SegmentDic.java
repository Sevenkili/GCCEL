...
public class SegmentDic {
	...
	public String Split(String input) throws UnsupportedEncodingException{
...
//	//	System.out.println("未导入用户词典的分词结果是：\t" + result);
		...
		// 添加用户词典分词
		int count = 0;
		String userDir = "Text/seguserDict.txt"; // 用户词典路径
...
//		String txt=mw.Merge(result1);
	...
	public static void main(String[] args) throws UnsupportedEncodingException {
		...
		String text = "杨洋是一名《快乐女声》选手。";
		System.out.println(sd.Split(text));
	}
}